...
<div>
    <br><br>
    <form action="<?php echo URL; ?>uebersicht/mitarbeiter/true" method="post">
        <label>Name: </label>
    ...
    <div style="margin: 0 auto; text-align: center;">
            ...
            if($_POST["absenden"] == "absenden") {
                if (empty($this->daten)) {
                    ...
                    echo "<h2> Mitarbeiter LaKitaOrga: " . $_POST["name"] . "</h2>
                    <br>
...
<script type="text/javascript">
    var URL_AJAX = "<?php echo URL;?>uebersicht/suchFeldMitarbeiter";
</script>
